  ...
  <div class="container">
   ...
   <div class="container-fluid">
        <div class="panel panel-primary">
          <div class="panel-heading" align="center">DOCTORS DASHBOARD
              </div><!--end of panel-heading-->
            <div class="panel-body">
       <div class="row" align="center">
                  <div class="col-sm-2" style="padding-bottom: 15px;">
                     <h3><p><a href="bookappointment.html">My Appointments</a></p></h3>
                </div>
           <div class="col-sm-2" style="padding-bottom:15px">
               <h3><p><a href="#">My Account</a></p></h3>
            </div>
                 <div class="col-sm-2">
                <h3><p><a href="#">Logout</a></p></h3>
           </div>
                </div><!--end of row-->
