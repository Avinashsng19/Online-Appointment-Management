...
<html lang="en">
 ...
 <body>
  ...
  <h3 style="color: blue">ADD DOCTORS TEST</h3><hr/>
    <div class="panel panel-default">
    <div class="panel-heading">Laboratory Test Management</div>
    ...
    <div class="form-group">
      <label class="control-label col-sm-2">Test Cost:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" name="cost">
      </div>
    </div>
       <div class="form-group">
      <label class="control-label col-sm-2">Test Duration:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" name="dur">
      </div>
    </div>
       <div class="form-group">
      <label class="control-label col-sm-2">Sample Reqiured:</label>
      <div class="col-sm-10">          
