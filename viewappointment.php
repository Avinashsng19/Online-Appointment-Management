...
<html lang="en">
 ...
 <body>
  ...
  <div class="container">
   ...
   <div class="container">
<h3 style="color: blue">APPOINTMENT REPORT</h3><hr/>
    <div class="panel panel-default">
    <div class="panel-heading">Appointment Listing Page</div>
    <div class="panel-body">
        ...
        <tbody>
		  ...
		  <tr>
            ...
            <td></td>
            <td></td>
            <td><a href="#"><button type="button" class="btn btn-success btn-md"><span class="glyphicon glyphicon-ok-circle"></span</button><button type="button" class="btn btn-danger btn-md"><span class="glyphicon glyphicon-remove-circle"></span></button></a>
          </tr>
		  <tr>
            <td></td>
            <td></td>
            ...
            <td></td>
            <td></td>
            <td><a href="#"><button type="button" class="btn btn-success btn-md"><span class="glyphicon glyphicon-ok-circle"></span</button><button type="button" class="btn btn-danger btn-md"><span class="glyphicon glyphicon-remove-circle"></span></button></a></a></td>
          </tr>
		  </tbody>
      </table>
      </div>
