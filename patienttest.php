...
<html lang="en">
 ...
 <body>
  ...
  <h3 style="color: blue">ADD DOCTORS PATIENT TEST</h3><hr/>
    <div class="panel panel-default">
    <div class="panel-heading">Patient Test Management</div>
         ...
         <form class="form-horizontal">
           <div class="form-group">
            ...
            <select class="form-control">
             ...
             <div class="form-group">
            <label class="control-label col-sm-2">Select Test:</label>
            <div class="col-sm-10">
            <select class="form-control">
               <option>Please Select</option>
                ...
                <option>Blood Clothing Test</option>
                <option>Computer Axial Tomography (CT or CAT Scan)</option>
                <option>X-Ray</option>
                <option>Haematological Tests</option>
              </select>
            </div>
             </div>
           <div class="form-group">
            <label class="control-label col-sm-2">Collection Date:</label>
            <div class="col-sm-10">
